export async function generateMetadata({ params }) {
  ...
  if (!subjectName) {
    return {
      title: 'Subject Not Found | TopTutor',
  ...
  const subjectSEO = {
    'mathematics': {
      title: `Best Mathematics Tutors Online | Expert Math Teachers | TopTutor`,
    ...
    'physics': {
      title: `Top Physics Tutors for JEE & NEET | Expert Physics Teachers | TopTutor`,
    ...
    'chemistry': {
      title: `Best Chemistry Tutors Online | Organic, Inorganic & Physical Chemistry | TopTutor`,
    ...
    'programming': {
      title: `Learn Programming from Expert Developers | Python, Java, Web Dev | TopTutor`,
  ...
  const seoData = subjectSEO[subjectSlug] || {
    title: `${subjectName} Tutors Online | Expert ${subjectName} Teachers | TopTutor`,
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://toptutor.com/tutors/${subjectSlug}`,
    },
    twitter: {
      title: seoData.title,
      description: seoData.description,
    ...
    alternates: {
      canonical: `https://toptutor.com/tutors/${subjectSlug}`,
    },
  }
}
